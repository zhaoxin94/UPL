...
def main(args):
    ...
    for i in range(int(cfg.TRAINER.ENSEMBLE_NUM)):
        ...
        if args.model_dir:
            trainer.load_model_by_id(args.model_dir,
                                     epoch=args.load_epoch,
                                     model_id=i)
        trainer_list.append(trainer)

        predict_label_dict, predict_conf_dict = trainer.load_from_exist_file(
            file_path='./analyze_results',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hh-config-file',
                        type=str,
                        default='',
                        help='path to config file')
