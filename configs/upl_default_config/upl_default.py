...
_C.DATASET.IGNORE_NUM = 0
_C.DATASET.IGNORE_FILE = ""
_C.DATASET.CLASS_EQULE = True
_C.DATASET.CONF_THRESHOLD = 0.9
...
###########################
_C.TEST = CN()
_C.TEST.EVALUATOR = "UPLClassification"
...
_C.TEST.Analyze_Result_Path = None
